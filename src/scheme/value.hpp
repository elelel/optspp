...
namespace optspp {
  namespace scheme {
    namespace tree {
      ...
      value& value::operator+=(const scheme::description& other) {
        auto l = static_cast<scheme::tree::node*>(this);
        auto r = static_cast<const scheme::tree::node*>(&other);
        if (r->description() != "") l->set_description(r->description());
        return *this;
      }
